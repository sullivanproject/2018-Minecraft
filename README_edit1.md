...
### Question 1
* Q .수업의 최종적 목표가 무엇? 학생들이 마지막에는 어떻게 변하게 될까요?

* A .아이들에게 친숙한 게임을 통해서 어렵게만 느껴지는 코딩에 대한 아이들의 인식의 장벽을 허무는 것이 저희의 목표입니다. 마지막엔 학생들이 코딩은 내가 만들고 싶은 것을 만들 수 있는 도구라는 인식을 갖게 되도록 할 것입니다.

### Question 2
* Q .강의 대상에 맞는 교육요소는 어떤것이 있을지?

* A .질문의 요점이 무엇인지 파악하지 못하였습니다.

### Question 3
* Q .7차시즈음부터 시간관리가 필요할 것. 6차시까지 마무리를 완벽히 할 수 있나요?

* A .2학년학생이 SW페스티벌에서 초등학생 저학년 대상으로 교육했을 때 매우 잘따라오는 모습을 보였으므로 충분히 가능할 것이라고 예상하고 있습니다.

### Question 4
* Q. 프로젝트를 2~3차시만에 할 수 있나요?

* A. 이 부분에 대해서는 저희의 경험이 부족해 아직 확실하게 말할 수 없기 때문에, 여름방학을 이용하여 팀원 모두가 각자 다른 게임을 기획한 후 제작해 보아 시간을 측정하겠습니다. 각자 해보고 무리가 있다는 생각이 들면, 전체 차시를 늘리는 방향으로 변경해야할 것 같습니다. 

### Question 5
* Q. 학생들의 코딩 지속 가능성에 대한 요소가 필요합니다. 이번 수업에서 끝나는 것이 아니라, 앞으로 계속 프로그래밍을 공부하기 위해서는 어떻게 해야할지 알려주는 요소들을 고민해보면 좋을 것 같습니다.

* A. 저희가 직접 JS로 만든 것들을 보여줌으로써 JS로 할 수 있는 작업들이 매우 다양함을 보여주고, 그 중 자신이 해보고 싶은 것은 무엇인지 생각해 보도록 하겠습니다.

### Question 6
* Q. 지루하지 않게 수업하는 방법은 무엇이 있을까?

* A. 제시해주신 2번의 방법이 좋다고 사료되오며 지금 당장은 결정하지 않았지만 계속 생각하며 2번의 방법을 발전시켜 최선의 방법을 생각해보겠습니다.
