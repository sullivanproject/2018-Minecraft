...
* [4. Feedback : 문답 & 수정사항](#4-feedback--문답-수정사항)
  * [1차 피드백](#1차-피드백---7월-10일)
  * [2차 피드백](#2차-피드백---9월-3일)
  * [3차 피드백](#3차-피드백---9월-11일)
...
> 지금까지 있던 교육과 여러분의 커리큘럼을 비교하여, “더 나은 교육”을 만들어 가는 과정입니다.
> 여러분이 찾은 ‘김왼손의 코딩교실’(아무래도 유튜브를 보신거겠죠?) 과 여러분의 커리큘럼을 비교하자면,
> 1. ‘김왼손의 코딩교실’은 어려분의 교육 목적을 달성하기에 어떤 부분이 문제일까요?
>     * 만약 문제가 될 부분이 잘 보이지 않는다면, ‘직접 자료 만들지 말고 유튜브에 있는 저 교육을 우리 수업에 사용하라고 하면?’라고 생각해보시면 좋을 것입니다. 저작권 이런거는 예외로 하고요.
>     * 제가 생각할때 예시) 김왼손은 게임을 이용하지 않기 때문에 코딩에 대한 장벽 허물기라는 목표를 달성 할 수 없다.
> 2. ‘김왼손의 코딩교실’과 우리 커리큘럼을 비교했을때 장점과 단점 비교.
